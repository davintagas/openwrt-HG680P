...
# Add theme
svn co https://github.com/kiddin9/openwrt-packages/trunk/{luci-theme-alpha,luci-theme-argon,luci-theme-design,luci-theme-edge,luci-app-design-config,luci-app-argon-config} package/
...
# Add luci-app-usbmodem
svn co https://github.com/kiddin9/openwrt-packages/trunk/{luci-app-usbmodem,quectel_QMI_WWAN,quectel_cm_5G} package/
...
#
pushd feeds/luci/modules/luci-mod-status/htdocs/luci-static/resources/view/status/include
rm -rf {10_system.js,19_cpu.js}
wget https://raw.githubusercontent.com/immortalwrt/luci/openwrt-21.02/modules/luci-mod-status/htdocs/luci-static/resources/view/status/include/10_system.js
popd
